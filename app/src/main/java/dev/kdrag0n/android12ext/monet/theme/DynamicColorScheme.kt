...
import dev.kdrag0n.android12ext.monet.colors.Srlab2.Companion.toSrlab2
import dev.kdrag0n.android12ext.monet.colors.Srlch2
import dev.kdrag0n.android12ext.monet.colors.Srlch2.Companion.toSrlch2
...
class DynamicColorScheme(
    ...
    private val primaryNeutral = primaryColor.toLinearSrgb().toSrlab2().toSrlch2().let { lch ->
    ...
    private fun transformColor(target: Lch, primary: Lch, targetLstar: Double): Srlch2 {
    ...
    private fun searchLstar(targetLstar: Double, C: Double, h: Double): Double {
        ...
        while (true) {
            ...
            val srgbClipped = Srlch2(mid, C, h).toSrlab2().toLinearSrgb().toSrgb().quantize8()

            // Convert back to Color and compare CIELAB L*
            val lstar = Srgb(srgbClipped).toLinearSrgb().toSrlab2().L
